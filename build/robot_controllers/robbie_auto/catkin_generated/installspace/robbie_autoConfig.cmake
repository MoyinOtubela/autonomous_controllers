...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'robbie_auto' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/moyin/dev/autonomous_controllers/install/${idir}'.  Ask the maintainer 'moyin <moyin@todo.todo>' to fix it.")
    endif()
